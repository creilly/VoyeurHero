...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'VHPost.user'
        db.add_column('backend_vhpost', 'user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'VHPost.user'
        db.delete_column('backend_vhpost', 'user_id')
