...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'VHProfile'
        db.create_table('backend_vhprofile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], unique=True)),
            ('lucky_number', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('backend', ['VHProfile'])


    def backwards(self, orm):
        
        # Deleting model 'VHProfile'
        db.delete_table('backend_vhprofile')
    ...
    models = {
        ...
        'backend.vhprofile': {
            'Meta': {'object_name': 'VHProfile'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lucky_number': ('django.db.models.fields.IntegerField', [], {}),
